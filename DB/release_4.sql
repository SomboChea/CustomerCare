...
-- ----------------------------
INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'1')
GO

INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'2')
GO

INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'3')
GO

INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'4')
GO

INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'5')
GO

INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'6')
GO

INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'8')
GO

INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'9')
GO

INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'10')
GO

INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'11')
GO

INSERT INTO [dbo].[tbl_access_options]  VALUES (N'1', N'12')
GO
...
CREATE TABLE [dbo].[tbl_address] (
  ...
  [hs_info] varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL
)
GO
...
INSERT INTO [dbo].[tbl_address] ([address_id], [sk_id], [st_road], [hs_info]) VALUES (N'1', N'2', N'St110, CPC', N'E201 KH')
GO
...
INSERT INTO [dbo].[tbl_mststaff] ([staff_id], [name_en], [name_kh], [pos_id], [emp_date], [tel_per1], [tel_per2], [tel_com], [email], [photo], [emp_note], [other]) VALUES (N'1', N'Sombo Chea', N'ជា សំបូរ', N'1', N'2018-01-11 15:24:18.0000000', N'0769995149', NULL, NULL, N'sombochea100@gmail.com', NULL, NULL, NULL)
GO
...
CREATE TABLE [dbo].[tbl_mum] (
  ...
  [mum_frm_source] varchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [mum_ept_date] datetime2(7)  NULL,
  [pro_id] int  NULL,
  [mum_fb] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
...
INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'1', N'Dashboard')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'2', N'Hospital')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'3', N'Retail')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'4', N'Mom')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'5', N'Kid')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'6', N'Staff')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'7', N'Address')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'8', N'Product')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'9', N'Category')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'10', N'Position')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'11', N'User')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'12', N'Call List')
GO

INSERT INTO [dbo].[tbl_options] ([option_id], [option_name]) VALUES (N'13', N'Help')
GO
...
INSERT INTO [dbo].[tbl_pos] ([pos_id], [pos_en], [pos_kh]) VALUES (N'1', N'Admin', N'ស')
GO

INSERT INTO [dbo].[tbl_pos] ([pos_id], [pos_en], [pos_kh]) VALUES (N'2', N'User', NULL)
GO

INSERT INTO [dbo].[tbl_pos] ([pos_id], [pos_en], [pos_kh]) VALUES (N'5', N'NewAdmin', NULL)
GO

INSERT INTO [dbo].[tbl_pos] ([pos_id], [pos_en], [pos_kh]) VALUES (N'6', N'Admin3', NULL)
GO
...
dbo.tbl_address.hs_info [house_info],
dbo.tbl_address.st_road [road_info],
...
ALTER TABLE [dbo].[tbl_access_options] ADD CONSTRAINT [FK__tbl_acces__pos_i__3B40CD36] FOREIGN KEY ([pos_id]) REFERENCES [dbo].[tbl_pos] ([pos_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
...
-- ----------------------------
ALTER TABLE [dbo].[tbl_address] ADD CONSTRAINT [FK__tbl_addre__sk_id__41EDCAC5] FOREIGN KEY ([sk_id]) REFERENCES [dbo].[tbl_sk] ([sk_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
...
-- ----------------------------
ALTER TABLE [dbo].[tbl_mststaff] ADD CONSTRAINT [FK__tbl_mstst__pos_i__70DDC3D8] FOREIGN KEY ([pos_id]) REFERENCES [dbo].[tbl_pos] ([pos_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
...
-- ----------------------------
ALTER TABLE [dbo].[tbl_mum] ADD CONSTRAINT [FK__tbl_mum__kid_id__76969D2E] FOREIGN KEY ([kid_id]) REFERENCES [dbo].[tbl_kid] ([kid_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO

ALTER TABLE [dbo].[tbl_mum] ADD CONSTRAINT [FK__tbl_mum__staff_i__778AC167] FOREIGN KEY ([staff_id]) REFERENCES [dbo].[tbl_mststaff] ([staff_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO

ALTER TABLE [dbo].[tbl_mum] ADD CONSTRAINT [FK__tbl_mum__hcp_id__787EE5A0] FOREIGN KEY ([hcp_id]) REFERENCES [dbo].[tbl_hcp] ([hcp_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO

ALTER TABLE [dbo].[tbl_mum] ADD CONSTRAINT [FK__tbl_mum__pro_id__797309D9] FOREIGN KEY ([pro_id]) REFERENCES [dbo].[tbl_product] ([pro_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
