...
-- ----------------------------
ALTER TABLE [dbo].[tbl_address] ADD CONSTRAINT [FK__tbl_addre__sk_id__41EDCAC5] FOREIGN KEY ([sk_id]) REFERENCES [tbl_sk] ([sk_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
...
-- ----------------------------
ALTER TABLE [dbo].[tbl_ks] ADD CONSTRAINT [FK__tbl_ks__pc_id__3E1D39E1] FOREIGN KEY ([pc_id]) REFERENCES [tbl_provinces] ([pc_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
...
ALTER TABLE [dbo].[tbl_mstretail] ADD CONSTRAINT [FK__tbl_mstre__addre__42E1EEFE] FOREIGN KEY ([address_id]) REFERENCES [tbl_address] ([address_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
...
-- ----------------------------
ALTER TABLE [dbo].[tbl_sk] ADD CONSTRAINT [FK__tbl_sk__ks_id__3F115E1A] FOREIGN KEY ([ks_id]) REFERENCES [tbl_ks] ([ks_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
