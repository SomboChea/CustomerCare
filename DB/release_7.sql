...
-- ----------------------------
ALTER TABLE [dbo].[tbl_mom] ADD CONSTRAINT [UQ__tbl_mom__7E1FAC9A6A1D075D] UNIQUE NONCLUSTERED ([name] ASC, [tel_1] ASC, [tel_2] ASC)
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[tbl_refer] ADD CONSTRAINT [UQ__tbl_refe__7E1FAC9AE8875C3B] UNIQUE NONCLUSTERED ([name] ASC, [tel_1] ASC, [tel_2] ASC)
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
